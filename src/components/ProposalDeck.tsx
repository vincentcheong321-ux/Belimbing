...
const DemoSimulation = () => {
  ...
  return (
     ...
     <div className="relative mx-auto bg-slate-800 border-[12px] border-slate-800 rounded-[2.5rem] h-[500px] w-[260px] shadow-2xl overflow-hidden transform-gpu">
        ...
        {/* Inner Screen Container - Radius set slightly larger (1.8rem) than calculated (2.5rem - 12px = ~1.75rem) to ensure full corner fill, relying on outer overflow-hidden to clip. */}
